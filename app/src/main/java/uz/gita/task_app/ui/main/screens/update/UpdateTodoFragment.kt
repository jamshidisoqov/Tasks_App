package uz.gita.task_app.ui.main.screens.update
...
import uz.gita.task_app.databinding.FragmentUpdateTodoBinding
import uz.gita.task_app.domain.presenter.main.UpdateTodoViewModel
import uz.gita.task_app.domain.presenter.main.impl.UpdateTodoViewModelImpl
...
class UpdateTodoFragment : Fragment(R.layout.fragment_update_todo) {
    ...
    private val viewModel: UpdateTodoViewModel by viewModels<UpdateTodoViewModelImpl>()
